...
// =============================================================================
// Stat strip (track record)
// =============================================================================
const STATS = [
  { n: "40+", label: "Years combined FP&A leadership" },
  { n: "$2.5B", label: "SOX-compliant revenue managed" },
  { n: "4–6 hrs", label: "Top-performing month-end close" },
  { n: "$80M", label: "Internal-audit gap closure delivered" },
];

// =============================================================================
// CUSTOMIZE: Logo strip. The agent must confirm with the client which past-
// employer logos Modelly has explicit permission to display. Until then,
// these are render placeholders with a "permission required" hint.
// =============================================================================
const TRUSTED_LOGOS = [
  "Rogers",
  "Vena",
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-24 md:py-40">
        ...
        {/* Stats strip */}
        <div
          className="grid grid-cols-2 md:grid-cols-4 mb-24"
          style={{
            borderTop: `1px solid ${COLORS.rule}`,
            borderBottom: `1px solid ${COLORS.rule}`,
          }}
          ...
          {STATS.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.08}>
              <div
                ...
                style={{
                  borderRight:
                    i < STATS.length - 1 ? `1px solid ${COLORS.rule}` : "none",
                  borderBottom:
                    i < 2 ? `1px solid ${COLORS.rule}` : "none",
                }}
              >
                <div
                  style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
          ...
          <Reveal>
            <div>
              {/* CUSTOMIZE: Replace with Fabio's professional headshot. Square crop, ~600px. */}
              <div
          ...
          <Reveal delay={0.1}>
            <div>
              {/* CUSTOMIZE: Replace with Jennifer's professional headshot. Square crop, ~600px. */}
              <div
                className="mb-6 aspect-square"
                style={{
                  backgroundColor: COLORS.paperElevated,
        ...
        <Reveal>
          ...
          >
            Built and refined inside
          </div>
          {/*
            CUSTOMIZE: Confirm with client which past-employer logos they have
            permission to display. Replace these text wordmarks with monochrome
            SVG logos once approved. Until then they render as styled text.
          */}
          <div
            className="grid grid-cols-2 md:grid-cols-6 gap-6 md:gap-12 items-center"
            style={{
              opacity: 0.7,
            }}
          >
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-24 md:py-40 relative">
        ...
        <Reveal delay={0.2}>
          <div className="flex flex-wrap items-center gap-8">
            {/* CUSTOMIZE: Replace href with the real Calendly / scheduling link. */}
            <PrimaryButton href="mailto:hello@modelly.ca" inverse>
              Schedule a discovery session
            </PrimaryButton>
            {/* CUSTOMIZE: Replace with the real contact email. */}
            <a
              href="mailto:hello@modelly.ca"
              className="inline-flex items-center gap-2 text-sm pb-1 border-b"
              style={{
                borderColor: COLORS.textInverse,
                color: COLORS.textInverse,
