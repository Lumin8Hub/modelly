...
export function Footer() {
  const links = [["Our Pillars", "/#pillars"], ["The Five Fs", "/#five-fs"], ["About Us", "/about"], ["Get Started", "/get-started"]];
  return <footer className="bg-ink-soft text-text-inverse">
    <div className="mx-auto max-w-container px-5 py-14 md:px-10">
      <div className="grid gap-10 md:grid-cols-3">
        <div><Logo inverse /><p className="mt-5 max-w-xs text-sm leading-6 text-white/65">Planning, forecasting and reporting systems built in the tools you already have.</p></div>
