...
export function PageHeader({ eyebrow, title, lede, body, breadcrumb, breadcrumbLabel, seed = 1, variant, draft, children }) {
  return <section className="bg-white">
    <div className="mx-auto grid max-w-container gap-12 px-5 py-12 md:grid-cols-[1fr_0.9fr] md:items-center md:px-10 md:py-20">
      ...
      <ModelPlaceholder variant={variant || (seed % 2 ? "bars" : "line")} seed={seed} />
    </div>
  </section>;
}
